...
impl InstallMount201ResponseData {
    pub fn new(agent: models::Agent, mounts: Vec<models::ShipMount>, cargo: models::ShipCargo, transaction: models::ShipModificationTransaction) -> InstallMount201ResponseData {
