...
impl ExtractResources201ResponseData {
    pub fn new(cooldown: models::Cooldown, extraction: models::Extraction, cargo: models::ShipCargo, events: Vec<models::ExtractResources201ResponseDataEventsInner>) -> ExtractResources201ResponseData {
