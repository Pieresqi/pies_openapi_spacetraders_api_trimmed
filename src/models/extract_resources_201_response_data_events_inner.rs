...
#[serde(untagged)]
pub enum ExtractResources201ResponseDataEventsInner {
    ShipConditionEvent(Box<models::ShipConditionEvent>),
}

impl Default for ExtractResources201ResponseDataEventsInner {
    fn default() -> Self {
        Self::ShipConditionEvent(Default::default())
    }
}
/// 
